...
st.title("Agriculture Modal Price Forecasting App")

state_input = st.text_input("Enter State", "Karnataka")
district_input = st.text_input("Enter District", "Belgaum")
commodity_input = st.text_input("Enter Commodity", "Tomato")
...
if st.button("Run Forecast"):
    ...
    if n_future <= 0:
        st.error("Future year must be greater than last year in data.")
        sys.exit()
